              ...
              return (
                <Magnetic key={social.key} strength={0.5}>
                  <a
                    ...
                    className="flex items-center justify-center w-11 h-11 rounded-full text-muted-foreground transition-all duration-300 ease-[var(--ease-premium)] hover:text-primary hover:shadow-[0_0_22px_rgba(215,255,61,0.45)]"
                  >
